...
# Added for matching command line args
test_profile = "example"
# test_cac_profile_op = f"{test_content_dir}/products/{test_product}/profiles/{test_profile}.profile"
...
def test_sync_product_create_validation_component(tmp_repo: Tuple[str, Repo]) -> None:
    ...
    result = runner.invoke(
        ...
        [
            ...
            "--cac-profile",
            # test_cac_profile,
            str(test_content_dir + test_cac_profile),
            "--oscal-profile",
            test_prof,
            "--committer-email",
            "test@email.com",
